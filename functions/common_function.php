                ...
                if(!isset($_GET['my_orders'])){
                    if(!isset($_GET['delete_account'])){
                        ...
                        if($row_count>0)
                        {
                            ...
                            echo "<p class='text-center'><a href='profile.php?my_orders' class='text-danger'>Order Details</a></p>";
                        }
                        else{
                            echo "<h3 class='text-center text-success mt-5 mb-2'>You Have Zero pending orders</h3>";
                            echo "<p class='text-center'><a href='../index.php' class='text-danger'>Explore Products</a></p>";
                        }
                    }
                }
            }
